...
import config
from .base_dataset import TrajectoryDataset, DatasetModes, SPATIAL_COLUMNS, SPATIAL_FEATURE
from conv_gan.utils.data import normalize_points

# Dataset Name
FSNYC = 'fs'

# Paths
PATH_ALL = config.BASE_DIR + 'data/fs_nyc/restricted_foursquare.csv'
...
class FSNYCDataset(TrajectoryDataset):
    ...
    def __init__(self, mode: DatasetModes = DatasetModes.ALL, spatial_columns: list = SPATIAL_COLUMNS,
                 latlon_only: bool = True, normalize: bool = True, return_labels: bool = False, sort: bool = False,
                 padding: bool = False, path: str = None, keep_original: bool = False,
                 reference_point: List[float] or dict = None, scale_factor: List[float] or dict = None,
