...
from conv_gan.utils.colors import bar_colors
...
def plot_pointclouds(points: Union[List[np.ndarray], np.ndarray],
    ...
    :param xlabel: The label for the x-axis. Default is 'Longitude'.
    :param ylabel: The label for the y-axis. Default is 'Latitude'.
    :param use_grid: A boolean indicating whether to display a grid on the plot. Default is True.
    :param color_id: An integer representing the index of the color to use for all point clouds. Default is None.
    :param color: A string representing the color to use for all point clouds. Default is None.
